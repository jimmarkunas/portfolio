...
console.log(`pdma-template-check: PASS — 10 templates, ${copyCount} mapped copy strings verified against copy authority, ${Object.keys(references.files).length} Canon v4 assets byte-identical, no pdmaGeometry`)
