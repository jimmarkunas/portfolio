...
for (const file of changedFiles) {
  ...
  else if (/src\/app\/pdma2026\/(index\.css|layout\.tsx|Pdma2026App\.tsx|pdma2026SlideManifest\.tsx|pdmaSlideAssets\.ts|pdmaSlideGeometry\.ts|PdmaPresentationShell\.tsx|components\/PdmaTitleBlock\.tsx)/.test(file) || /src\/app\/pdma2026\/components\/pdmaSlidePrimitives\.tsx/.test(file)) {
