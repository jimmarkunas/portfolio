...
if (liveRoute.includes("CaseStudyTemplate") || !liveRoute.includes("content/case-studies/revamp/case-study-registry")) errors.push("live route imports legacy architecture or wrong case-study registry")
if (printRoute.includes("CaseStudyTemplate") || !printRoute.includes("content/case-studies/revamp/case-study-registry")) errors.push("print route imports legacy architecture or wrong case-study registry")
const redundantAdapterPath = path.join(root, "src/content/case-studies/revamp", ["live", "registry.ts"].join("-"))
if (fs.existsSync(redundantAdapterPath)) errors.push("redundant live registry adapter remains active")
