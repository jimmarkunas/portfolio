---
title: American Apparel — Omni-Channel Rescue During Turnaround
slug: american-apparel-omnichannel-rescue
source_title: Saving American Apparel With Digital
source_url: https://www.notion.so/2d03c5a059268047a8a4c653ea498818
client: American Apparel
role: Product Manager & Program Manager
timeline: June 2013 – June 2015
services:
- Product Management
...
# American Apparel — Omni-Channel Rescue During Turnaround

## Overview
American Apparel was under intense pressure: fragmented global sites, inaccurate inventory, manual store processes, and a board-level mandate to make digital and omni-channel move the numbers fast.

The work was not just a re-platform. It was a turnaround program that used Oracle ATG, item-level RFID, and omni-channel order logic to turn stores, factory, and web into one operating system.
...
- The business needed better merchandising, routing, and store-anchored conversion without breaking an already chaotic operation.

## My Role
Amanda Lopez carried the board-level vision; I served as the technical co-pilot turning that ambition into a working system.
...
## Outcomes
- Digital revenue increased by 43%+.
- Store sales rose by 14%+ through omni-channel flows.
- Shrink dropped by 65%+.
- The business gained a credible digital and inventory operating model during a period when failure could have materially worsened the turnaround.
