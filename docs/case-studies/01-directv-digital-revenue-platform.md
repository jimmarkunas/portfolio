---
title: DIRECTV — Digital Revenue Platform and Upsell Engine
slug: directv-digital-revenue-platform
source_title: DIRECTV PRODUCT LAUNCH 2025
source_url: https://www.notion.so/2d03c5a0592681aea6d8d7eef6766039
client: DIRECTV
...
# DIRECTV — Digital Revenue Platform and Upsell Engine

## Overview
DIRECTV needed more than another digital-transformation slide deck. It needed an owner for a fragmented upsell and retention journey spanning legacy satellite, streaming products, set-top box surfaces, mobile, and web.

The work treated the revenue platform as both a product and an operating model: unify the journey, reduce campaign delay, and make premium content easier to discover and buy across channels.
...
- Sports calendars and business timing were unforgiving.

## My Role
I operated as both program and product lead for the digital revenue platform.
...
## Outcomes
- Time-to-value improved by 60 days for major sports offers.
- The platform contributed to a reported $55M upsell revenue uplift in Q4 2025.
- The improved add-on ecosystem earned positive outside attention according to the source page.
