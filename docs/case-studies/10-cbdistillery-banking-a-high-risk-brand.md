---
title: CBDistillery — Banking a High-Risk Brand
slug: cbdistillery-banking-a-high-risk-brand
source_title: CBDistillery Fintech Product Launch
source_url: https://www.notion.so/2d03c5a059268018a297ca335d7117b6
client: CBDistillery
role: Senior Product Manager & Solutions Architect
timeline: '2020'
services:
- Solutioning
- Sales Engineering
...
# CBDistillery — Banking a High-Risk Brand

## Overview
CBDistillery did not just need a nicer storefront. The company had been dropped by its payment provider and was at risk of losing the ability to process cards at all.

The work centered on solving the existential payments problem first, then building a subscription-ready commerce stack that could scale on BigCommerce without constant operational risk.
...
- The business needed a processor, gateway, commerce platform, and subscription platform that could all be underwritten and operated reliably.

## My Role
I acted as the product and solution lead across payments, platform selection, and launch architecture.
...
- Aligned commerce, subscriptions, and finance around one coherent flow instead of disconnected tools.

## Outcomes
- GMV grew from roughly $15M to $40M.
- Subscription growth exceeded 18%.
- Subscription retention reached 89%.
- Most importantly, the business moved from a fragile high-risk payments situation to an operable, scalable digital model.
