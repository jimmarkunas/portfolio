---
title: Mrs. Meyer’s — From Shelf-Only Brand to DTC Engine
slug: mrs-meyers-dtc-launch
source_title: Mrs. Meyer’s eCommerce Launch
source_url: https://www.notion.so/2d03c5a059268110be69fabe4e532c0f
client: SC Johnson / Mrs. Meyer’s
...
# Mrs. Meyer’s — From Shelf-Only Brand to DTC Engine

## Overview
Mrs. Meyer’s had strong retail love but no direct-to-consumer channel of its own. The challenge was to stand up a modern DTC business without breaking SC Johnson's existing enterprise supply chain and operating model.

This case is as much about creating a reusable enterprise DTC pattern as it is about launching one consumer brand.
...
- The business needed a new revenue channel without destabilizing existing retail operations.

## My Role
I led solutioning, integration design, and overall program alignment across SCJ, agencies, BigCommerce, and supporting systems.
...
## Outcomes
- DTC revenue lifted by 15%+.
- One unified stack replaced fragmented logic across 10+ systems.
- The architecture enabled at least two follow-on brand launches.
