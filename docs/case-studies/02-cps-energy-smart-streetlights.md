---
title: CPS Energy — Smart Streetlights and Smart City Operations
slug: cps-energy-smart-streetlights
source_title: CPS Energy Smart Streetlights
source_url: https://www.notion.so/2d03c5a05926810380bce3c1f5d414bf
client: CPS Energy & Dalkia
...
# CPS Energy — Smart Streetlights and Smart City Operations

## Overview
This program started as a public trust problem, not a tidy requirements doc. Residents were reporting dark streets, support calls were disappearing into manual workflows, and no one could answer basic operational questions with confidence.

The goal was to make streetlight repair feel like a modern utility service: one front door for residents, one operating view for CPS and Dalkia, and a foundation for smarter, greener city infrastructure.
...
- The program sat inside utility politics, vendor politics, and city politics simultaneously.

## My Role
I operated across product, program, and stakeholder alignment.
...
## Outcomes
- Streetlight-related calls dropped by 73%.
- Repair timelines improved from roughly 3 weeks to 1–4 days.
- Truck rolls fell by 43%.
- The program helped CPS Energy and San Antonio earn Smart 20 recognition.
