...
export type Pdma2026SlideManifestEntry = { key: Pdma2026SlideKey; id: string; tocTitle: string; footerLabel: string; title: PdmaTitleConfig; component: Pdma2026SlideComponent; assets: readonly string[] };
...
const slides: readonly Omit<Pdma2026SlideManifestEntry, "footerLabel">[] = [
  { key: "slide-01", id: "slide-01", tocTitle: "THE NEW PM OPERATING SYSTEM", title: { white: "THE NEW PM", magenta: "OPERATING SYSTEM", subtitle: <>What stays uniquely human.<br />What shifts to AI.</>, size: 82, leading: 88, tracking: -2.4, subtitleSize: 30, subtitleLeading: 36 }, component: Slide01, assets: pdmaSlideAssets["slide-01"] },
  { key: "slide-02", id: "slide-02", tocTitle: "WHAT SHIFTS. WHAT STAYS.", title: { ...standard, white: "WHAT SHIFTS.", magenta: "WHAT STAYS.", subtitle: <>AI automates the grunt work.<br />It does not change who owns the product outcome.</>, subtitleSize: 38 }, component: Slide02, assets: pdmaSlideAssets["slide-02"] },
  ...
  { key: "slide-07", id: "slide-07", tocTitle: "BEFORE YOU BUILD IT, PROVE THE VALUE.", title: { ...standard, white: "BEFORE YOU BUILD IT,", magenta: "PROVE THE VALUE.", subtitle: "Every Agentic Product should have a clear economic reason to exist. Pick one primary value driver.", subtitleSize: 27, subtitleLeading: 36 }, component: Slide07, assets: pdmaSlideAssets["slide-07"] },
  ...
  { key: "slide-11", id: "slide-11", tocTitle: "A.G.E.N.T.S.", title: { ...standard, magenta: "A.G.E.N.T.S.", subtitle: "Six product questions that turn an Agentic AI idea into something a team can safely build, test, and operate.", subtitleSize: 29 }, component: Slide11, assets: pdmaSlideAssets["slide-11"] },
  { key: "slide-12", id: "slide-12", tocTitle: "TURN THE FRAMEWORK INTO PRODUCT.", title: { ...standard, white: "TURN THE FRAMEWORK", magenta: "INTO PRODUCT.", subtitle: "A.G.E.N.T.S. changes how you write your backlog.", subtitleSize: 24 }, component: Slide12, assets: pdmaSlideAssets["slide-12"] },
  { key: "slide-13", id: "slide-13", tocTitle: "AN IDEA + AI ≠ PRODUCT SPEC.", title: { ...standard, white: "AN IDEA + AI", magenta: "≠ PRODUCT SPEC.", subtitle: "Same starting point. Different outcomes.", subtitleSize: 30, sameRow: true, magentaX: 659 }, component: Slide13, assets: pdmaSlideAssets["slide-13"] },
  { key: "slide-14", id: "slide-14", tocTitle: "NOW YOU DO IT.", title: { ...standard, white: "NOW YOU", magenta: "DO IT.", subtitle: "Turn an AI idea into a mini productization brief you can take back to work.", subtitleSize: 30, sameRow: true, magentaX: 700 }, component: Slide14, assets: pdmaSlideAssets["slide-14"] },
  { key: "slide-15", id: "slide-15", tocTitle: "TURN AI CAPABILITY INTO PRODUCT VALUE.", title: { ...standard, white: "TURN AI CAPABILITY", magenta: "INTO PRODUCT VALUE.", subtitle: "Start with the business case. Define the authority. Productize the controls. Measure the outcome.", subtitleSize: 30 }, component: Slide15, assets: pdmaSlideAssets["slide-15"] },
];
