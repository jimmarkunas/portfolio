...
export type Pdma2026SlideManifestEntry = { key: Pdma2026SlideKey; id: string; tocTitle: string; headerLabels: PdmaHeaderLabels; footerLabel: string; title: PdmaTitleConfig; component: Pdma2026SlideComponent; assets: readonly string[] };

const standard = { size: 82, leading: 88, tracking: -2.4 };
const approvedChromeSemantics: readonly { headerLabels: PdmaHeaderLabels; footerLabel: string }[] = [
  { headerLabels: ["JUDGMENT", "AUTHORITY", "ACCOUNTABILITY"], footerLabel: "HUMAN JUDGMENT COMPOUNDS" },
  { headerLabels: ["OWNERSHIP", "JUDGMENT", "AUTOMATION"], footerLabel: "DELEGATED WORK • HUMAN JUDGMENT" },
  { headerLabels: ["OUTPUTS", "AUTHORITY", "ACTION"], footerLabel: "AUTHORITY IS A PRODUCT DECISION" },
  { headerLabels: ["AUTOMATE", "AUGMENT", "HUMAN-OWNED"], footerLabel: "BUILD THE RIGHT OPERATING MODEL" },
  { headerLabels: ["PROBLEM", "OWNER", "AUTHORITY"], footerLabel: "CONFUSION AT MACHINE SPEED" },
  { headerLabels: ["SYSTEMS", "DATA", "OWNERSHIP"], footerLabel: "AUTOMATION DOES NOT ERASE OWNERSHIP" },
  { headerLabels: ["REVENUE", "COST", "OPERATIONS"], footerLabel: "PICK ONE PRIMARY VALUE DRIVER" },
  { headerLabels: ["OBSERVE", "DECIDE", "EXECUTE"], footerLabel: "AUTHORITY IS A PRODUCT DECISION" },
  { headerLabels: ["VALUE", "SIGNAL", "ACTION"], footerLabel: "PRODUCTION-READY ENTERPRISE PRODUCT" },
  { headerLabels: ["BACKLOG", "CONTROLS", "OUTCOMES"], footerLabel: "PRODUCTION READINESS STARTS IN THE BACKLOG" },
  { headerLabels: ["STANDARD", "PRODUCT", "GOVERN"], footerLabel: "6 QUESTIONS • 1 PRODUCTIZATION STANDARD" },
  { headerLabels: ["FRAMEWORK", "REQUIREMENTS", "PRODUCT"], footerLabel: "FRAMEWORK → REQUIREMENTS → BUILDABLE PRODUCT" },
  { headerLabels: ["IDEA", "REQUIREMENTS", "PRODUCT"], footerLabel: "LESS REWORK • FASTER DELIVERY • HIGHER CONFIDENCE" },
  { headerLabels: ["APPLY", "DECIDE", "BUILD"], footerLabel: "USEFUL PM ARTIFACT • NOT JUST A QUIZ RESULT" },
  { headerLabels: ["VALUE", "AUTHORITY", "ACCOUNTABILITY"], footerLabel: "NEVER AUTOMATE AWAY ACCOUNTABILITY" },
] as const;
const slides: readonly Pdma2026SlideManifestEntry[] = [
  { key: "slide-01", id: "slide-01", tocTitle: "THE NEW PM OPERATING SYSTEM", headerLabels: ["JUDGMENT", "AUTHORITY", "ACCOUNTABILITY"], footerLabel: "HUMAN JUDGMENT COMPOUNDS", title: { white: "THE NEW PM", magenta: "OPERATING SYSTEM", subtitle: <>What stays uniquely human.<br />What shifts to AI.</>, size: 82, leading: 88, tracking: -2.4, subtitleSize: 30, subtitleLeading: 36 }, component: Slide01, assets: pdmaSlideAssets["slide-01"] },
  { key: "slide-02", id: "slide-02", tocTitle: "WHAT SHIFTS. WHAT STAYS.", headerLabels: ["OWNERSHIP", "JUDGMENT", "AUTOMATION"], footerLabel: "DELEGATED WORK • HUMAN JUDGMENT", title: { ...standard, white: "WHAT SHIFTS.", magenta: "WHAT STAYS.", subtitle: <>AI automates the grunt work.<br />It does not change who owns the product outcome.</>, subtitleSize: 38 }, component: Slide02, assets: pdmaSlideAssets["slide-02"] },
  { key: "slide-03", id: "slide-03", tocTitle: "COPILOTS GENERATE OUTPUTS. AGENTS TAKE ACTION.", headerLabels: ["OUTPUTS", "AUTHORITY", "ACTION"], footerLabel: "AUTHORITY IS A PRODUCT DECISION", title: { ...standard, white: "COPILOTS GENERATE OUTPUTS.", magenta: "AGENTS TAKE ACTION.", subtitle: <>When AI can act in enterprise systems, product design must account for<br />authority, consequence, and control.</>, subtitleSize: 29, subtitleLeading: 42 }, component: Slide03, assets: pdmaSlideAssets["slide-03"] },
  { key: "slide-04", id: "slide-04", tocTitle: "DON'T AUTOMATE EVERYTHING.", headerLabels: ["AUTOMATE", "AUGMENT", "HUMAN-OWNED"], footerLabel: "BUILD THE RIGHT OPERATING MODEL", title: { ...standard, white: "DON'T AUTOMATE", magenta: "EVERYTHING.", subtitle: <>Decide what problem deserves automation,<br />what outcome matters, and what tradeoffs you’re willing to accept.</>, subtitleSize: 31, subtitleLeading: 40 }, component: Slide04, assets: pdmaSlideAssets["slide-04"] },
  { key: "slide-05", id: "slide-05", tocTitle: "DON'T AUTOMATE AMBIGUITY.", headerLabels: ["PROBLEM", "OWNER", "AUTHORITY"], footerLabel: "CONFUSION AT MACHINE SPEED", title: { ...standard, white: "DON'T AUTOMATE", magenta: "AMBIGUITY", tracking: -5 }, component: Slide05, assets: pdmaSlideAssets["slide-05"] },
  { key: "slide-06", id: "slide-06", tocTitle: "UNDERSTAND THE ENVIRONMENT. NAME THE OWNERS.", headerLabels: ["SYSTEMS", "DATA", "OWNERSHIP"], footerLabel: "AUTOMATION DOES NOT ERASE OWNERSHIP", title: { white: "UNDERSTAND THE ENVIRONMENT.", magenta: "NAME THE OWNERS.", subtitle: <>AI inherits systems, data, permissions, dependencies, and failure modes —<br />while autonomous actions still cross human ownership boundaries.</>, size: 64, leading: 70, tracking: 0, subtitleSize: 29, subtitleLeading: 36, subtitleOffset: 17, subtitleX: 50, subtitleTracking: 0, exactSubtitleSize: true, titleColor: "#f2f2f2", subtitleColor: "#f2f2f2", magentaRowShift: -2 }, component: Slide06, assets: pdmaSlideAssets["slide-06"] },
  { key: "slide-07", id: "slide-07", tocTitle: "BEFORE YOU BUILD IT, PROVE THE VALUE.", headerLabels: ["REVENUE", "COST", "OPERATIONS"], footerLabel: "PICK ONE PRIMARY VALUE DRIVER", title: { ...standard, white: "BEFORE YOU BUILD IT,", magenta: "PROVE THE VALUE.", subtitle: "Every Agentic Product should have a clear economic reason to exist. Pick one primary value driver.", subtitleSize: 27, subtitleLeading: 36 }, component: Slide07, assets: pdmaSlideAssets["slide-07"] },
  { key: "slide-08", id: "slide-08", tocTitle: "HOW MUCH AUTHORITY SHOULD THE ROBOTS HAVE?", headerLabels: ["OBSERVE", "DECIDE", "EXECUTE"], footerLabel: "AUTHORITY IS A PRODUCT DECISION", title: { ...standard, white: "HOW MUCH AUTHORITY", magenta: "SHOULD THE ROBOTS HAVE?", subtitle: <>The farther AI moves from observing to acting, the more deliberately<br />the Product Manager has to design the boundary.</>, subtitleSize: 26 }, component: Slide08, assets: pdmaSlideAssets["slide-08"] },
  { key: "slide-09", id: "slide-09", tocTitle: "LIVE SCENARIO: RETENTION AGENT.", headerLabels: ["VALUE", "SIGNAL", "ACTION"], footerLabel: "PRODUCTION-READY ENTERPRISE PRODUCT", title: { ...standard, white: "LIVE SCENARIO:", magenta: "RETENTION AGENT.", subtitle: "A real enterprise business case: detect churn risk across CRM, product-usage, and support data before it is too late to act.", subtitleSize: 29 }, component: Slide09, assets: pdmaSlideAssets["slide-09"] },
  { key: "slide-10", id: "slide-10", tocTitle: "DESIGN PRODUCTION READINESS INTO THE FEATURE.", headerLabels: ["BACKLOG", "CONTROLS", "OUTCOMES"], footerLabel: "PRODUCTION READINESS STARTS IN THE BACKLOG", title: { ...standard, white: "DESIGN PRODUCTION READINESS", magenta: "INTO THE FEATURE.", subtitle: <>Guardrails, human intervention, and success measures belong in the product<br />requirements before development begins.</>, subtitleSize: 24 }, component: Slide10, assets: pdmaSlideAssets["slide-10"] },
  { key: "slide-11", id: "slide-11", tocTitle: "A.G.E.N.T.S.", headerLabels: ["STANDARD", "PRODUCT", "GOVERN"], footerLabel: "6 QUESTIONS • 1 PRODUCTIZATION STANDARD", title: { ...standard, magenta: "A.G.E.N.T.S.", subtitle: "Six product questions that turn an Agentic AI idea into something a team can safely build, test, and operate.", subtitleSize: 29 }, component: Slide11, assets: pdmaSlideAssets["slide-11"] },
  { key: "slide-12", id: "slide-12", tocTitle: "TURN THE FRAMEWORK INTO PRODUCT.", headerLabels: ["FRAMEWORK", "REQUIREMENTS", "PRODUCT"], footerLabel: "FRAMEWORK → REQUIREMENTS → BUILDABLE PRODUCT", title: { ...standard, white: "TURN THE FRAMEWORK", magenta: "INTO PRODUCT.", subtitle: "A.G.E.N.T.S. changes how you write your backlog.", subtitleSize: 24 }, component: Slide12, assets: pdmaSlideAssets["slide-12"] },
  { key: "slide-13", id: "slide-13", tocTitle: "AN IDEA + AI ≠ PRODUCT SPEC.", headerLabels: ["IDEA", "REQUIREMENTS", "PRODUCT"], footerLabel: "LESS REWORK • FASTER DELIVERY • HIGHER CONFIDENCE", title: { ...standard, white: "AN IDEA + AI", magenta: "≠ PRODUCT SPEC.", subtitle: "Same starting point. Different outcomes.", subtitleSize: 30, sameRow: true, magentaX: 659 }, component: Slide13, assets: pdmaSlideAssets["slide-13"] },
  { key: "slide-14", id: "slide-14", tocTitle: "NOW YOU DO IT.", headerLabels: ["APPLY", "DECIDE", "BUILD"], footerLabel: "USEFUL PM ARTIFACT • NOT JUST A QUIZ RESULT", title: { ...standard, white: "NOW YOU", magenta: "DO IT.", subtitle: "Turn an AI idea into a mini productization brief you can take back to work.", subtitleSize: 30 }, component: Slide14, assets: pdmaSlideAssets["slide-14"] },
  { key: "slide-15", id: "slide-15", tocTitle: "TURN AI CAPABILITY INTO PRODUCT VALUE.", headerLabels: ["VALUE", "AUTHORITY", "ACCOUNTABILITY"], footerLabel: "NEVER AUTOMATE AWAY ACCOUNTABILITY", title: { ...standard, white: "TURN AI CAPABILITY", magenta: "INTO PRODUCT VALUE.", subtitle: "Start with the business case. Define the authority. Productize the controls. Measure the outcome.", subtitleSize: 30 }, component: Slide15, assets: pdmaSlideAssets["slide-15"] },
];
...
export function assertPdma2026ManifestParity(manifest: readonly Pdma2026SlideManifestEntry[], renderedSlides: readonly ReactNode[]) {
  ...
  if (manifest.length !== approvedChromeSemantics.length || manifest.some((entry, index) => entry.headerLabels.join(" • ") !== approvedChromeSemantics[index].headerLabels.join(" • ") || entry.footerLabel !== approvedChromeSemantics[index].footerLabel)) throw new Error("PDMA manifest/render parity failed: chrome semantics do not match the approved 15-row mapping");
}
