...
4:{...standard,white:"DON'T AUTOMATE",magenta:"EVERYTHING.",subtitle:<>Judgment is deciding what problem deserves automation,<br/>what outcome matters, and what tradeoffs you’re willing to accept.</>,subtitleSize:31,subtitleLeading:40},
