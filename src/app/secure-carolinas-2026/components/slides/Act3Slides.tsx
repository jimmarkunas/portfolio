  ...
  return (
    <div className="sc26-slide-wrapper">
      ...
      <div className="my-auto space-y-5 lg:space-y-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {copy.capabilities.map((capability, index) => (
              <motion.div
                ...
                className="flex min-h-[145px] items-center gap-4 rounded-2xl border border-[#E4E4E7] bg-[#F8F8F9] px-5 lg:min-h-[165px] lg:px-6"
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-[#E4E4E7] bg-white">
                  {icons[index]}
                </div>
                <div>
                  <div className="text-xl font-semibold leading-tight text-[#18181B] lg:text-[1.65rem]">{capability.label}</div>
                  <div className="mt-1.5 text-sm leading-snug text-[#71717A] lg:text-base">{capability.desc}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="sc26-surface-card-accent flex items-center justify-center px-8 py-5 text-center lg:py-6">
          <p className="text-3xl font-semibold leading-tight text-[#18181B] lg:text-[2.4rem]">
