        ...
        <div className="flex flex-col gap-14 md:gap-16 lg:gap-20">
          <div className="flex flex-col gap-10 md:gap-12 lg:gap-[52px]">
            <MotionReveal preset="hero" className="w-full" delay={0.02}>
              <section className="flex flex-col gap-5 p-4 lg:flex-col">
                <div className="order-1">
                  ...
                  <h1 className="type-h2 mt-5 text-[#232323]">{agentsContent.hero.title}</h1>
                ...
                <div className="order-2">
                  ...
                  <TrackedExternalLink
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-3 ml-[20px] inline-text-cta type-p4 lg:hidden"
                    ariaLabel="Report adoption"
                  >
                    {agentsContent.hero.tertiaryCta}
                  </TrackedExternalLink>
