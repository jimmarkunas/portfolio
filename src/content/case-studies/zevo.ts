...
export const zevoCaseStudy = {
  ...
  atAGlance: {
    ...
    stats: [
      { value: "$20", suffix: "M", label: "Initial Raise Target" },
      { value: "30k", suffix: "+", label: "Concept Video Views" },
      { value: "3", suffix: "", label: "Tier-1 VC Firms Pitched" },
  ...
  problem: {
    ...
    projectOverviewRows: [
      { label: "Company", value: "ZEVO" },
      { label: "Industry", value: "Media • Streaming • Interactive Commerce" },
      { label: "Timeline", value: "2010" },
    ],
    tools: [
      { label: "Web Platform", icon: "/tool-icons/svg/icon-web.svg" },
      { label: "API Services", icon: "/tool-icons/svg/icon-api.svg" },
      { label: "Mobile Sync", icon: "/tool-icons/svg/icon-mobile.svg" },
      { label: "Commerce Layer", icon: "/tool-icons/svg/icon-shopping-bag.svg" },
    ],
    quote: {
      quote:
  ...
  role: {
    ...
    stats: [
      { value: "1", suffix: "", label: "Unified Platform" },
      { value: "3", suffix: "", label: "Tier-1 VC Cycles" },
      { value: "30k", suffix: "+", label: "Narrative Reach" },
      { value: "1", suffix: " yr", label: "Build Window" },
    ],
    narrative: {
      ...
      highlights: [
        ...
        "Aligned product narrative to investor risk concerns.",
      ],
      closing:
  ...
  solution: {
    ...
    heroImage: "/founder/zevo/banner-zevo-07.jpg",
  },
  supplementalNarrative: {
    title: "The Product Thesis Was Early, Not Random",
    paragraphs: [
    ...
    highlights: [
      "Strong concept clarity can still fail when market confidence isn't ready.",
      "Narrative quality matters, but evidence and sequencing matter too.",
      "Knowing when to stop can be as valuable as knowing when to push.",
    ],
    closing:
    ...
    closingImage: "/founder/zevo/banner-zevo-06.png",
  },
  impact: {
    eyebrow: "Impact",
    ...
    proofPoints: ["Ready", "Fire", "Aim"],
    stats: [
      { value: "30k", suffix: "+", label: "Concept Story Views" },
      { value: "3", suffix: "", label: "Tier-1 Investor Pitches" },
      { value: "10", suffix: "", label: "Team Size" },
      { value: "$20", suffix: "M", label: "Raise Target" },
    ],
    statsImage: "/founder/zevo/banner-zevo-01.png",
    beforeAfter: {
      title: "Before & After",
      summary:
    ...
    journeySteps: [
      {
        step: "1",
        title: "Defined the Product Thesis",
        copy:
      ...
      {
        step: "2",
        title: "Tested It Through Real Stakeholders",
        copy:
      ...
      {
        step: "3",
        title: "Made the Hard Leadership Call",
        copy:
  ...
  delivery: {
    ...
    introTitle: "From Concept to Capital Decision",
    introCopy:
  ...
  recognition: {
    ...
    featured: {
      ...
      tags: ["Demo", "Investor Narrative"],
    },
    rows: [
      {
        company: "Oak Investment Partners Meeting Cycle",
      ...
      {
        company: "Norwest Venture Partners Meeting Cycle",
        source: "Investor Room",
        dates: "2010",
        summary:
      ...
      {
        company: "Ashton Kutcher Team Discussion",
        source: "Talent / Strategic",
        dates: "2010",
        summary:
