...
export const aaRevampCaseStudy = {
  ...
  "hero": {
    ...
    "metrics": [
      ...
      },
      {
        "value": "14",
        "suffix": "%",
        "label": "Retail Channel Uplift"
      },
      {
        "value": "300",
        "suffix": "%",
        "label": "Omni-Channel Growth"
      }
    ],
    "image": {
      "kind": "image",
  ...
  "executiveBrief": {
    ...
    "tools": [
      ...
      {
        "label": "MS Dynamics",
        "icon": "/tool-icons/msdynamics-logo.png"
      },
      {
        "label": "Oracle ATG",
    ...
    "facts": [
      ...
      },
      {
        "icon": "client",
        "label": "Industry",
        "value": "Retail • Apparel • Omni-Channel Commerce"
      },
      {
        "icon": "timeline",
        "label": "Timeline",
        "value": "Jun 2013 - Jun 2015"
      },
      {
        "icon": "team",
      ...
      },
      {
        ...
        "value": "Oracle ATG, RFID, MS Dynamics, Azure"
      }
    ]
  },
  "challenge": {
  ...
  "ownership": {
    ...
    "editorialImage": {
      "src": "/aa/hero-aa-02.png",
      "alt": "American Apparel omni-channel commerce impact imagery",
      "width": 2880,
      "height": 1164
    },
    "decisions": [
      {
        "title": "Owned the Program Layer",
        "copy": "I owned the product & program layer that connected global IA, PRDs, integration design, launch plans, and omni-channel logic across stores, factory, and web."
      },
      {
        "title": "Unified the Global Platform",
        "copy": "Moved 16 international sites onto one Oracle ATG commerce model w/ shared integrations and release logic."
      },
      {
        "title": "Made Inventory Real",
        "copy": "Made RFID the inventory truth layer across stores, factory, and digital experiences."
      },
      {
        "title": "Designed Smart Fulfillment",
        "copy": "Designed the order-routing logic behind BOPIS and ship-to-store to balance fulfillment speed, cost, and store traffic."
      },
      {
        "title": "Connected Stores, Factory, and Web",
        "copy": "I helped unify 16 international Oracle ATG storefronts, real-time RFID inventory across the entire globe, and omni-channel order routing into one commercial system that retail, factory, and web could finally share."
      }
    ]
  },
  "solution": {
    ...
    "architecture": [
      {
        ...
        "title": "Shared Commerce Core",
        "copy": "16 sites, one Oracle ATG model.",
        "bullets": [
          "16 international storefronts",
          "Shared templates and integrations",
          "One global release model"
        ],
        "image": {
          "src": "/aa/modal-aa-02.png",
          "alt": "American Apparel global Oracle ATG commerce model",
          "width": 1792,
          "height": 1856
        }
      },
      {
        ...
        "copy": "RFID made inventory visible.",
        "bullets": [
          "Stores, factory, and digital",
          "One inventory truth layer",
          "Improved inventory accuracy"
        ],
        "image": {
          "src": "/aa/modal-aa-03.png",
          "alt": "American Apparel RFID inventory visibility",
          "width": 1792,
          "height": 1856
        }
      },
      {
        "eyebrow": "Omni-Channel Fulfillment",
        "title": "Smart Fulfillment",
        "copy": "BOPIS and routing connected stores.",
        "bullets": [
          "BOPIS and ship-to-store",
          "Inventory-aware routing",
          "Stores connected to digital"
        ],
        "image": {
          "src": "/aa/modal-aa-04.png",
          "alt": "American Apparel omni-channel fulfillment",
          "width": 1792,
          "height": 1856
        }
      }
  ...
  "impact": {
    ...
    "editorialImage": {
      "src": "/aa/banner-aa-010.jpg",
      "alt": "American Apparel billboard campaign banner",
      "width": 2048,
      "height": 1024
    },
    "metrics": [
    ...
    "transformation": {
      ...
      "rows": [
        {
          "problem": "Regional stores & operations didn't share inventory truth. Customers couldn't reliably trust product availability.",
          "decision": "I pushed RFID and inventory visibility into the core of the customer and fulfillment experience so stores and web stopped disagreeing about what existed.",
          "outcome": "RFID-driven inventory visibility reduced shrink by 65%."
        },
        {
          "problem": "The business needed digital to move revenue fast across a fragmented global footprint.",
          "decision": "I helped consolidate 16 regional storefronts onto one Oracle ATG model so the business could move globally instead of piecemeal.",
          "outcome": "Digital revenue rose 43% and store sales rose 14%."
        },
        {
          "problem": "Stores were disconnected from digital fulfillment and omni-channel orders started from zero.",
          "decision": "I helped build BOPIS, ship-to-store, and routing logic that made every order a smarter retail decision.",
          "outcome": "Omni-channel growth reached 300%."
        }
      ]
    }
  },
  "evidence": {
    ...
    "testimonial": {
      "quote": "Q1 revenue is up thanks to your work. You moved mountains to make it happen!",
  ...
  "recognition": {
    ...
    "featured": {
      ...
      "title": "American Apparel files for bankruptcy",
      "date": "Oct 5, 2015",
      "summary": "After a series of scandals and lawsuits, American Apparel is filing for bankruptcy. Buzzfeed News' Business Reporter Sapna Maheshwari spoke to CBSN about the filing.",
      "tags": [
        "News",
        "CBS"
      ]
    ...
    "rows": [
      {
        "publisher": "Object Edge",
        "date": "2015",
        "summary": "American Apparel Drives Sales and Customer Loyalty With the Right Commerce Experience — Object Edge documented the global Oracle ATG rollout and the sales lift that followed the omni-channel commerce transformation, including more than 38% eCommerce sales growth.",
        "pdfHref": "/aa/files/01-objectedge-casestudy.pdf"
      },
      {
        "publisher": "Microsoft",
        "date": "2013",
        "summary": "American Apparel Uses RFID and Business Intelligence to Improve Inventory Accuracy and Sales — Microsoft documented store sales growth, lower inventory handling costs, stronger margins, and real-time visibility driven by the RFID and BI stack.",
        "pdfHref": "/aa/files/03-microsoft-casestudy.pdf"
      },
      {
        "publisher": "Motorola",
        "date": "2012",
        "summary": "American Apparel Deploys Motorola RFID Across Its Supply Chain for Product Visibility — Motorola documented the RFID rollout and showed how item-level inventory visibility dramatically improved stock accuracy, cycle counts, and store operations.",
        "pdfHref": "/aa/files/02-motorola-casestudy.pdf"
      }
    ]
  },
  "relatedStudies": {
  ...
  "finalCta": {
    "eyebrow": "Next step",
    "title": "Review the American Apparel parity preview.",
    "copy": "This preview preserves the legacy content represented by the shared revamp schema."
  }
