...
export const aaRevampCaseStudy = {
  ...
  executiveBrief: {
    ...
    teamStakeholders: "7-person team · 260+ stores worldwide · 16 international sites",
    budgetScale: "$6M program budget",
    systemsTechnology: "Oracle ATG, RFID, MS Dynamics, Azure; 16 international sites and 260+ stores",
    tools,
