...
const record = (
  ...
  sourceReadiness: CaseStudySourceReadiness,
  bespokeSolution: boolean,
  extras: Partial<Pick<CaseStudyPreviewRecord, "migrationStatus" | "previewHref" | "approvedTag" | "notes" | "loadContent" | "loadTemplate">> = {},
...
export const caseStudyPreviewRegistry: CaseStudyPreviewRecord[] = [
  record("cps", "CPS Energy: Smart Streetlight & Smart City Operations", "C", "complete", true, { previewHref: "/work/case-study-test/cps", loadContent: () => import("./cps").then((module) => module.cpsRevampCaseStudy), loadTemplate: CaseStudyRevampCpsTemplate }),
  record("dtv01", "Turning DIRECTV's Slow Offer Engine to a Revenue Machine", "B", "complete", false, { previewHref: "/work/case-study-test/dtv01", loadContent: () => import("./dtv01").then((module) => module.dtv01RevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("newyorklife", "New York Life's Scalable Product Platform", "C", "complete", true, { previewHref: "/work/case-study-test/newyorklife", loadContent: () => import("./newyorklife").then((module) => module.newyorklifeRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("modere", "Winning Awards And Making $1B With Modere", "C", "complete", true, {
    ...
    loadTemplate: CaseStudyRevampModereTemplate,
  }),
  ...
  record("mm", "Launching Mrs. Meyer's First DTC Channel From Scratch", "C", "complete", true, { previewHref: "/work/case-study-test/mm", loadContent: () => import("./mm").then((module) => module.mmRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("method", "Method: Brand-True DTC Launch on Shared Rails", "C", "complete", true, { previewHref: "/work/case-study-test/method", loadContent: () => import("./method").then((module) => module.methodRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("murad", "Murad: From Chaos to Creation", "C", "complete", true, { previewHref: "/work/case-study-test/murad", loadContent: () => import("./murad").then((module) => module.muradRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("k2", "Headless/Composable Commerce for 9 K2 Brands", "C", "complete", true, { previewHref: "/work/case-study-test/k2", loadContent: () => import("./k2").then((module) => module.k2RevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("cbdistillery", "CBDistillery's: From De-Banked to $40m", "B", "complete", false, { previewHref: "/work/case-study-test/cbdistillery", loadContent: () => import("./cbdistillery").then((module) => module.cbdistilleryRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  ...
  record("lego", "LEGO's Digital Transformation With BCG", "B", "complete", false, { previewHref: "/work/case-study-test/lego", loadContent: () => import("./lego").then((module) => module.legoRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("cwg", "Chicks With Guns: Building a Digital Music Magazine", "D", "complete", true, {
    previewHref: "/work/case-study-test/cwg", loadContent: () => import("./cwg").then((module) => module.cwgRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate,
  ...
  record("zevo", "Interactive Internet TV Before it was Mainstream", "D", "complete", true, {
    previewHref: "/work/case-study-test/zevo", loadContent: () => import("./zevo").then((module) => module.zevoRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate,
    notes: "Founder-specific template required",
  }),
  record("dtv02", "Leading the Launch of DIRECTV Everywhere", "B", "complete", false, { previewHref: "/work/case-study-test/dtv02", loadContent: () => import("./dtv02").then((module) => module.dtv02RevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
]
