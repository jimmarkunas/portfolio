...
export const caseStudyPreviewRegistry: CaseStudyPreviewRecord[] = [
  ...
  record("mm", "Launching Mrs. Meyer's First DTC Channel From Scratch", "C", "complete", true, { migrationStatus: "in-progress", routeKind: "dynamic", previewHref: "/work/case-study-test/mm", loadContent: () => import("./mm").then((module) => module.mmRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("method", "Method: Brand-True DTC Launch on Shared Rails", "C", "complete", true, { migrationStatus: "in-progress", routeKind: "dynamic", previewHref: "/work/case-study-test/method", loadContent: () => import("./method").then((module) => module.methodRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("murad", "Murad: From Chaos to Creation", "C", "complete", true, { migrationStatus: "in-progress", routeKind: "dynamic", previewHref: "/work/case-study-test/murad", loadContent: () => import("./murad").then((module) => module.muradRevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
  record("k2", "Headless/Composable Commerce for 9 K2 Brands", "C", "complete", true, { migrationStatus: "in-progress", routeKind: "dynamic", previewHref: "/work/case-study-test/k2", loadContent: () => import("./k2").then((module) => module.k2RevampCaseStudy), loadTemplate: CaseStudyRevampTemplate }),
