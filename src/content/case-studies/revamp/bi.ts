...
export const biRevampCaseStudy = {
  ...
  "hero": {
    ...
    "image": {
      "kind": "image",
      "src": "/bi/hero-bi-01.png",
      "alt": "Boehringer Ingelheim global B2B commerce — animal health program delivery",
      "aspectRatio": "16/9"
    }
  },
  "productionQuote": {
  ...
  "executiveBrief": {
    ...
    "facts": [
      ...
      },
      {
        "icon": "client",
        "label": "Industry",
        "value": "Animal Health • B2B Commerce • Pharmaceuticals"
      },
      {
        "icon": "timeline",
        "label": "Timeline",
        "value": "Sep 2020 – Mar 2023"
      },
      {
        "icon": "team",
    ...
    "architecture": [
      {
        ...
        "title": "One Global Model, Controlled Local Variation",
        "copy": "Global consistency with room for markets to adapt.",
        "bullets": [
          "Adobe Commerce Cloud as the global commerce layer",
          "AEM for content and experience management",
          "SAP as commercial source of truth",
          "MuleSoft as the integration spine",
          "8 system integrations"
        ]
      },
      {
        "eyebrow": "ERP Migration",
        "title": "Oracle and SAP Running Side-by-Side Without Breaking Commerce",
        "copy": "Parallel systems, sequenced cutovers, protected continuity.",
        "bullets": [
          "Oracle-to-SAP migration alongside live commerce",
          "Country-by-country cutover sequencing",
          "SAP established as commercial source of truth",
          "Commerce and migration moved in parallel"
        ]
      },
      {
        "eyebrow": "B2B Commerce",
        "title": "Procurement That Works Without a Phone Call",
        "copy": "Self-service ordering for regulated market conditions.",
        "bullets": [
          "Country-specific catalog eligibility",
          "Regulated B2B ordering flows",
          "Template-based market adaptation",
          "Reduced support and escalation burden"
        ]
      }
    ],
  ...
  "impact": {
    ...
    "metrics": [
      ...
      },
      {
        ...
        "suffix": "%+",
        "label": "Order Throughput",
        "detail": "Order throughput improvement post-launch"
      },
      {
        "value": "12",
        "suffix": "%",
        "label": "Less Escalations",
        "detail": "Reduction in service escalations post-launch"
      },
      {
        "value": "30",
        "suffix": "%",
