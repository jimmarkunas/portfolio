...
export const directveverywhereCopy = {
  ...
  roleNarrative: {
    ...
    closing: `This is how I turn campaign pressure and org chaos into a real consumer product that moves the needle.`,
  },
  solutionCopy: `I helped turn DIRECTV Everywhere from a campaign idea to a coherent product by defining what needed to stay consistent across devices, what content the service could credibly promise, and how subscribers should move through one authenticated experience.`,
  supplementalNarrative: {
    ...
    closing: `DIRECTV Everywhere mattered because it proved DTV could behave like a streaming product company, not just advertise like one.`,
  },
  impactIntro: `DIRECTV Everywhere became more than just a slick marketing campaign. It turned into a real product that customers downloaded, used across devices, and expanded into it's own standalone product still sold today.`,
  impactBeforeAfterSummary: `Trad TV masquerading as digital to best-in-class cross-platform streaming.`,
  ...
  deliveryIntroCopy: `This launch had to move from campaign promise to working product under intense public and internal pressure. The program moved through product definition, entitlement alignment, device rollout, and scale-up stages, all while keeping a large organization in step.`,
  recognitionIntro: `DIRECTV Everywhere represented a real shift in how traditional pay-TV providers showed up in the streaming era. Press coverage tracked the rollout from beta to cross-platform expansion, then followed the service as it widened device support, channel reach, and network partnerships.`,
}
