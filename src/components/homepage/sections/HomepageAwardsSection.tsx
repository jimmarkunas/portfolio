          ...
          <MotionReveal preset="hero" className="w-full" delay={0.02}>
            <HomepageSectionHeader label={section.pill}>
              <div className={`${HOMEPAGE_SECTION_HEADER_TITLE_GROUP_CLASS} items-start`}>
                <h2 className={`${HOMEPAGE_SECTION_HEADER_TITLE_CLASS} max-w-none 2xl:max-w-[396px] text-[#222222]`}>
                  {section.title}
                </h2>
                <p className="type-p2 max-w-none 2xl:max-w-[482px] text-black/70">{section.description}</p>
              </div>
            </HomepageSectionHeader>
          </MotionReveal>
